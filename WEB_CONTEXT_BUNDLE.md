...
```json
{
  ...
  "problem_contract": {
    ...
    "problem_id": "problem:um-amr-010-0123-questions-in-geometric-group-theory-q-2ed723b5",
    "quantifiers": [
      {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-amr-010-0123-dd9a98b9748c",
        "url": "https://www.unsolvedmath.com/problems/AMR-010-0123"
      }
    ],
    "statement": {
      "language": "en",
      "text": "(Ian Leary) Is there a version of the Kan-Thurston theorem using only CAT(-1) groups, or word hyperbolic groups? (The statement should be: for any finite simplicial complex X, there is a locally CAT(-1) polyhedral complex Y and a map Y →X that is surjective on fundamental groups and induces an isomorphism on homology for any local coefficients on X.)",
      "version": 1
    },
    "title": "Questions in Geometric Group Theory — Q 1.23",
    "updated_at": "2026-09-15T21:28:00.195364Z"
  },
  "problem_contract_sha256": "3a2299d24a8b43d679b4d1cf75c9185aa63c8776feedba6b09042d505c341df5"
}
```
